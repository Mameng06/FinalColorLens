...
export const styles = StyleSheet.create({
  ...
  crosshairHint: { textAlign: 'center', color: '#FFFFFF', marginTop: rf(8), fontSize: rf(13), fontWeight: '600' },
  ...
  infoArea: { padding: 20 },
  infoRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: rf(10), width: '100%' },
